...
_FAQ_ENTRIES: list[tuple[str, str, str, str]] = [
    (
        ...
        "where it published a usable one. Ten of the 112 events on record carry a "
        "field this project settled instead, nine of those at a floor of 24 that "
    ...
    (
        ...
        "project separates them into numbered careers. 49 of the 1,136 names offered "
    ...
    (
        ...
        "About half the decks on record carry more than one archetype (2,420 of "
        "4,711), each weighted, and a deck counts only under its main one. So a "
