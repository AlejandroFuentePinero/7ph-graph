...
Two archetypes leave the app. Black Walks and Deadpool Walks are nobody's primary, so they hold no decks under the rule and stop being drawn anywhere, which is what the rule means rather than a side effect of it.
